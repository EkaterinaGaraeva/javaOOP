...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Product chocolate1 = new Chocolate("Красный октябрь", "Аленка", 110, 100, 550);
        Product chocolate2 = new Chocolate("Бабаевский", "Бабаевский", 120, 100, 490);
        Product chocolate3 = new Chocolate("Mondelēz International", "Милка", 130, 100, 545);

        arrayList.add(chocolate1);
        arrayList.add(chocolate2);
        arrayList.add(chocolate3);

        Chocolate chocolate = vendingMachine.getChocolate("Аленка", 100);
        if (chocolate != null){
            System.out.println("Вы купили:");
